...
export interface EnergyTokenInterface extends Interface {
  ...
  encodeFunctionData(
    functionFragment: "totalEnergyBurned",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "totalEnergyMinted",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "userTotalMinted",
    values: [AddressLike]
  ): string;
...
export interface EnergyToken extends BaseContract {
  ...
  totalEnergyBurned: TypedContractMethod<[], [bigint], "view">;

  totalEnergyMinted: TypedContractMethod<[], [bigint], "view">;
  ...
  userTotalMinted: TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getFunction(
    nameOrSignature: "totalEnergyBurned"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
    nameOrSignature: "totalEnergyMinted"
  ): TypedContractMethod<[], [bigint], "view">;
  getFunction(
  ...
  getFunction(
    nameOrSignature: "userTotalMinted"
  ): TypedContractMethod<[arg0: AddressLike], [bigint], "view">;
  ...
  getEvent(
    ...
    EnergyBurnedEvent.InputTuple,
    EnergyBurnedEvent.OutputTuple,
    EnergyBurnedEvent.OutputObject
  >;
  getEvent(
    key: "EnergyMinted"
  ): TypedContractEvent<
    EnergyMintedEvent.InputTuple,
    EnergyMintedEvent.OutputTuple,
    EnergyMintedEvent.OutputObject
  >;
  getEvent(
    key: "MinterAdded"
  ): TypedContractEvent<
  ...
  filters: {
    ...
    "EnergyBurned(address,uint256,uint256)": TypedContractEvent<
      EnergyBurnedEvent.InputTuple,
      EnergyBurnedEvent.OutputTuple,
      EnergyBurnedEvent.OutputObject
    >;
    EnergyBurned: TypedContractEvent<
      EnergyBurnedEvent.InputTuple,
      EnergyBurnedEvent.OutputTuple,
      EnergyBurnedEvent.OutputObject
    >;

    "EnergyMinted(address,uint256,uint256)": TypedContractEvent<
      EnergyMintedEvent.InputTuple,
      EnergyMintedEvent.OutputTuple,
      EnergyMintedEvent.OutputObject
    >;
    EnergyMinted: TypedContractEvent<
      EnergyMintedEvent.InputTuple,
      EnergyMintedEvent.OutputTuple,
      EnergyMintedEvent.OutputObject
    >;
